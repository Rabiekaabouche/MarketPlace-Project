...
<section class="collection">
    <div class="container py-5 px-0">
        ...
        @if (count($products)!=0)
        <h2 class="text-center border-bottom shadow-sm p-3"><span>{{$products[0]['NomCat']}}</span></h2>
    ...
    <div class="row py-5">
        ...
        @else
            <div class="col-md-10 text-center m-auto">Aucun produit n'éxiste dans cette catégorie</div>
        @endif
    </div>
